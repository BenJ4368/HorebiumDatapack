summon item ~0.5 ~0.75 ~0.5 {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Chunkloader","italic":false}',Lore:['{"text":"HorebiumDatapack","color":"dark_purple","italic":false}']},CustomModelData:4368202,EntityTag:{Silent:1b,Tags:["HRB_chunkloader"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:4368202}},Fixed:1b,Invisible:1b,Invulnerable:1b}}}}
