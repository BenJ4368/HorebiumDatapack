...
summon item ~0.5 ~0.75 ~0.5 {Item:{id:"minecraft:flint",Count:1b,tag:{display:{Name:'{"text":"Horebium","italic":false}',Lore:['{"text":"HorebiumDatapack","color":"dark_purple","italic":false}']},CustomModelData:4368001}}}