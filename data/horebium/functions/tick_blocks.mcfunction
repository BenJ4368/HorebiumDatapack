...
execute as @e[type=item_frame,tag=HRB_forge] at @s if entity @e[type=item_frame,tag=HRB_forge,distance=..15] run function horebium:blocks/forge/place_error_too_close
